...
/* color mapping */
enum { normalBit, inverseBit, blueBit, greenBit, redBit, blackBit, yellowBit, magentaBit, cyanBit };

typedef char QDByte, *QDPtr, **QDHandle;

typedef enum { bold = 1, italic = 2, underline = 4, outline = 8, shadow = 16, condense = 32, extend = 64 } Style;
