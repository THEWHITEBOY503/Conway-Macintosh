...
enum { documentProc, dBoxProc, plainDBox, altDBoxProc, noGrowDocProc, rDocProc = 16 };
...
/*  FindWindow values  */
enum { inDesk, inMenuBar, inSysWindow, inContent, inDrag, inGrow, inGoAway, inZoomIn, inZoomOut };

/* Axis constraints for DragGrayRgn */
enum { noConstraint, hAxisOnly, vAxisOnly };

/*  window defproc messages  */
enum { wDraw, wHit, wCalcRgns, wNew, wDispose, wGrow, wDrawGIcon };

/*  hit test codes  */
enum { wNoHit, wInContent, wInDrag, wInGrow, wInGoAway, wInZoomIn, wInZoomOut };
